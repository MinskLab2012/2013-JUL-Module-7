          --1--
    SELECT DISTINCT CONNECT_BY_ROOT ( links.child_geo_id ) country_geo_id
                  , links.parent_geo_id
                  , links.link_type_id
                  ...
                  , CASE WHEN ( links.link_type_id = 4 ) THEN links.parent_geo_id ELSE NULL END AS group_system_geo_id
                  , LEVEL
      FROM w_geo_object_links links
