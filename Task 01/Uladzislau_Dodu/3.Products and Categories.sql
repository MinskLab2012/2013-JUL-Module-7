/* Formatted on 7/30/2013 3:34:14 PM (QP5 v5.139.911.3011) */
...
INSERT INTO temp_products ( prod_id
                          , prod_name
                          , prod_desc
                          , prod_subcategory
                          , prod_subcategory_id
...
CREATE TABLE ext_prod_categories
AS
   SELECT prod_category_id
     ...
     FROM temp_products;
            ...
            DROP TABLE temp_products CASCADE CONSTRAINT PURGE
