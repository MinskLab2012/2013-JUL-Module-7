...
--/
--
drop table u_dw_stage.t_cntr_sub_groups cascade constraints
/

--==============================================================
-- Table: t_cntr_sub_groups                                     
--==============================================================
create table u_dw_stage.t_cntr_sub_groups 
(
...
comment on table u_dw_stage.t_cntr_sub_groups is
'Referense store: Grouping Countries - Sub Groups'
/

comment on column u_dw_stage.t_cntr_sub_groups.geo_id is
'Unique ID for All Geography objects'
/

comment on column u_dw_stage.t_cntr_sub_groups.sub_group_id is
'ID Code of Countries Sub Groups'
/

alter table u_dw_stage.t_cntr_sub_groups
...
create trigger u_dw_stage.bi_t_cntr_sub_groups before insert
on u_dw_stage.t_cntr_sub_groups for each row
declare
