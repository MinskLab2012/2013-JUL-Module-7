...
--
drop table u_dw_stage.t_geo_object_links cascade constraints;

--==============================================================
-- Table: t_geo_object_links                                    
--==============================================================
create table u_dw_stage.t_geo_object_links 
(
...
comment on table u_dw_stage.t_geo_object_links is
'Reference store: All links between Geo Objects';

comment on column u_dw_stage.t_geo_object_links.parent_geo_id is
'Parent objects of Geo_IDs';

comment on column u_dw_stage.t_geo_object_links.child_geo_id is
'Child objects of Geo_IDs';

comment on column u_dw_stage.t_geo_object_links.link_type_id is
'Type of Links, between Geo_IDs';

alter table u_dw_stage.t_geo_object_links
