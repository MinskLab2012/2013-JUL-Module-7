...
--
drop table u_dw_stage.lc_geo_systems cascade constraints;

--==============================================================
-- Table: lc_geo_systems                                        
--==============================================================
create table u_dw_stage.lc_geo_systems 
(
   ...
   constraint PK_LC_GEO_SYSTEMS primary key (geo_id)
         using index tablespace ts_dw_stage_idx_01
)
tablespace ts_dw_stage_data_01;

comment on table u_dw_stage.lc_geo_systems is
'Localization table: T_GEO_SYSTEMS';

comment on column u_dw_stage.lc_geo_systems.geo_id is
'Unique ID for All Geography objects';

comment on column u_dw_stage.lc_geo_systems.geo_system_id is
'ID Code of Geography System Specifications';

comment on column u_dw_stage.lc_geo_systems.geo_system_code is
'Code of Geography System Specifications';

comment on column u_dw_stage.lc_geo_systems.geo_system_desc is
'Description of Geography System Specifications';


alter table u_dw_stage.lc_geo_systems
...
alter table u_dw_stage.lc_geo_systems
   add constraint FK_LC_GEO_SYSTEMS foreign key (geo_id)
      references u_dw_stage.t_geo_systems (geo_id)
      on delete cascade;
