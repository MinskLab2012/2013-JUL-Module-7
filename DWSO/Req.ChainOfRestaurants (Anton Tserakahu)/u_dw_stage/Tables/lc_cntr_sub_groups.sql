...
--
drop table u_dw_stage.lc_cntr_sub_groups cascade constraints;

--==============================================================
-- Table: lc_cntr_sub_groups                                    
--==============================================================
create table u_dw_stage.lc_cntr_sub_groups 
(
   ...
   constraint PK_LC_CNTR_SUB_GROUPS primary key (geo_id)
         using index tablespace ts_dw_stage_idx_01
)
tablespace ts_dw_stage_data_01;

comment on table u_dw_stage.lc_cntr_sub_groups is
'Localization table: T_GEO_SYSTEMS';

comment on column u_dw_stage.lc_cntr_sub_groups.geo_id is
'Unique ID for All Geography objects';

comment on column u_dw_stage.lc_cntr_sub_groups.sub_group_id is
'ID Code of Countries Sub Groups';

comment on column u_dw_stage.lc_cntr_sub_groups.sub_group_code is
'Code of Countries Sub Groups';

comment on column u_dw_stage.lc_cntr_sub_groups.sub_group_desc is
'Description of Countries Sub Groups';


alter table u_dw_stage.lc_cntr_sub_groups
...
alter table u_dw_stage.lc_cntr_sub_groups
   add constraint FK_LC_CNTR_SUB_GROUPS foreign key (geo_id)
      references u_dw_stage.t_cntr_sub_groups (geo_id)
      on delete cascade;
