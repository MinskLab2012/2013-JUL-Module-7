...
--/
--
drop table u_dw_stage.t_cntr_group_systems cascade constraints
/

--==============================================================
-- Table: t_cntr_group_systems                                  
--==============================================================
create table u_dw_stage.t_cntr_group_systems 
(
...
comment on table u_dw_stage.t_cntr_group_systems is
'Referense store:  Grouping Systems of Countries'
/

comment on column u_dw_stage.t_cntr_group_systems.geo_id is
'Unique ID for All Geography objects'
/

comment on column u_dw_stage.t_cntr_group_systems.grp_system_id is
'ID Code of Grouping System Specifications'
/

alter table u_dw_stage.t_cntr_group_systems
...
create trigger u_dw_stage.bi_t_cntr_group_systems before insert
on u_dw_stage.t_cntr_group_systems for each row
declare
