...
--/
--
drop table u_dw_stage.t_countries cascade constraints;
--/

--==============================================================
-- Table: t_countries                                           
--==============================================================
create table u_dw_stage.t_countries 
(
...
comment on table u_dw_stage.t_countries is
'Referense store: Geographical Countries'
/

comment on column u_dw_stage.t_countries.geo_id is
'Unique ID for All Geography objects'
/

comment on column u_dw_stage.t_countries.country_id is
'ID Code of Country'
/

alter table u_dw_stage.t_countries
...
create trigger u_dw_stage.bu_t_countries before insert
on u_dw_stage.t_countries for each row
declare
