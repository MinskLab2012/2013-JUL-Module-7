...
--/
--
drop table u_dw_stage.t_geo_regions cascade constraints
/

--==============================================================
-- Table: t_geo_regions                                         
--==============================================================
create table u_dw_stage.t_geo_regions 
(
...
comment on table u_dw_stage.t_geo_regions is
'Referense store: Geographical Continents - Regions'
/

comment on column u_dw_stage.t_geo_regions.geo_id is
'Unique ID for All Geography objects'
/

comment on column u_dw_stage.t_geo_regions.region_id is
'ID Code of Geographical Continent - Regions'
/

alter table u_dw_stage.t_geo_regions
...
create trigger u_dw_stage.bu_t_regions before insert
on u_dw_stage.t_geo_regions for each row
declare
