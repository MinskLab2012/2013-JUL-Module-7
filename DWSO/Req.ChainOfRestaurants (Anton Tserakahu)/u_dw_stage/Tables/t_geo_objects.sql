...
--
drop table u_dw_stage.t_geo_objects cascade constraints;

--==============================================================
-- Table: t_geo_objects                                         
--==============================================================
create table u_dw_stage.t_geo_objects 
(
...
comment on table u_dw_stage.t_geo_objects is
'Abstarct Referense store all Geography objects';

comment on column u_dw_stage.t_geo_objects.geo_id is
'Unique ID for All Geography objects';

comment on column u_dw_stage.t_geo_objects.geo_type_id is
'Code of Geography Type Objects';

comment on column u_dw_stage.t_geo_objects.geo_code_id is
'NK: Source ID from source systems';

--==============================================================
-- Index: ui_geo_objects_codes                                  
--==============================================================
create unique index u_dw_stage.ui_geo_objects_codes on u_dw_stage.t_geo_objects (
   geo_type_id ASC,
   geo_code_id ASC
)
tablespace ts_dw_stage_idx_01;

alter table u_dw_stage.t_geo_objects
   add constraint FK_T_GEO_TYPES2T_GEO_OBJECTS foreign key (geo_type_id)
      references u_dw_stage.t_geo_types (geo_type_id);
