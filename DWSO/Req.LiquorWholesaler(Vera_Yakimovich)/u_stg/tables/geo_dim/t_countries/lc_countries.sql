...
drop table u_stg.lc_countries cascade constraints;

--==============================================================
-- Table: lc_countries                                          
--==============================================================
create table u_stg.lc_countries 
(
...
comment on table u_stg.lc_countries is
'Localization table: T_COUNTRIES';

comment on column u_stg.lc_countries.geo_id is
'Unique ID for All Geography objects';

comment on column u_stg.lc_countries.country_id is
'ID Code of Country';

comment on column u_stg.lc_countries.country_code_a2 is
'Code of Countries - ALPHA 2';

comment on column u_stg.lc_countries.country_code_a3 is
'Code of Countries - ALPHA 3';

comment on column u_stg.lc_countries.country_desc is
'Description of Countries';

comment on column u_stg.lc_countries.localization_id is
...
alter table u_stg.lc_countries
   add constraint FK_LC_COUNTRIES foreign key (geo_id)
      references u_stg.t_countries (geo_id)
      on delete cascade;
