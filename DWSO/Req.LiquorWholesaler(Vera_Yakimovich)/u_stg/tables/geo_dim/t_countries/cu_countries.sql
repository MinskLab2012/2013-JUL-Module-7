--drop view u_stg.cu_countries;

--==============================================================
-- View: cu_countries                                           
--==============================================================
create or replace view u_stg.cu_countries as
SELECT src.geo_id
...
comment on column u_stg.cu_countries.geo_id is
'Unique ID for All Geography objects';

comment on column u_stg.cu_countries.country_id is
'ID Code of Country';
