drop table u_stg.t_geo_types cascade constraints;

--==============================================================
-- Table: t_geo_types                                           
--==============================================================
create table u_stg.t_geo_types 
(
...
organization index
 tablespace ts_stg_data_01
    pctthreshold 10
 overflow tablespace ts_stg_data_01;

comment on table u_stg.t_geo_types is
'Reference store all abstraction types of geograhy objects';

comment on column u_stg.t_geo_types.geo_type_id is
'ID of unique Type - abstraction code for Geo Objects ';

comment on column u_stg.t_geo_types.geo_type_code is
'Code of Geography Type Objects';

comment on column u_stg.t_geo_types.geo_type_desc is
'Description of Geography Type Objects (Not Localizable)';

alter table u_stg.t_geo_types
