--drop view u_stg.cu_geo_regions;

--==============================================================
-- View: cu_geo_regions                                         
--==============================================================
create or replace view u_stg.cu_geo_regions as
SELECT src.geo_id
...
comment on column u_stg.cu_geo_regions.geo_id is
'Unique ID for All Geography objects';

comment on column u_stg.cu_geo_regions.src_continent_id is
