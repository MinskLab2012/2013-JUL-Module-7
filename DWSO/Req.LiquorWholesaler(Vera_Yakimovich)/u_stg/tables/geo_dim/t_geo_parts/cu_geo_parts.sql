--drop view u_stg.cu_geo_parts;

--==============================================================
-- View: cu_geo_parts                                           
--==============================================================
create or replace view u_stg.cu_geo_parts as
select
   src.geo_id,
...
comment on column u_stg.cu_geo_parts.geo_id is
'Unique ID for All Geography objects';

comment on column u_stg.cu_geo_parts.part_id is
