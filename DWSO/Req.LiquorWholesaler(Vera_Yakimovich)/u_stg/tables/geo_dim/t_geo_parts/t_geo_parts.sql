drop trigger u_stg.bi_t_geo_parts
/
...
alter table u_stg.t_geo_parts
   drop constraint FK_T_GEO_OBJECTS2PARTS
/

drop table u_stg.t_geo_parts cascade constraints
/
--
--==============================================================
-- Table: t_geo_parts                                           
--==============================================================
create table u_stg.t_geo_parts 
(
...
comment on table u_stg.t_geo_parts is
'Referense store: Geographical Parts of Worlds'
/

comment on column u_stg.t_geo_parts.geo_id is
'Unique ID for All Geography objects'
/

comment on column u_stg.t_geo_parts.part_id is
...
create trigger u_stg.bi_t_geo_parts before insert
on u_stg.t_geo_parts for each row
declare
