--drop trigger dw.bi_t_cntr_group_systems
--/
--
--alter table dw.t_cntr_group_systems
--   drop constraint FK_T_GEO_OBJECTS2CNTR_G_SYSTEM
--/
--
--drop table dw.t_cntr_group_systems cascade constraints
--/

--==============================================================
-- Table: t_cntr_group_systems                                  
--==============================================================
create table dw.t_cntr_group_systems 
(
...
comment on table dw.t_cntr_group_systems is
'Referense store:  Grouping Systems of Countries'
/

comment on column dw.t_cntr_group_systems.geo_id is
'Unique ID for All Geography objects'
/

comment on column dw.t_cntr_group_systems.grp_system_id is
...
create trigger dw.bi_t_cntr_group_systems before insert
on dw.t_cntr_group_systems for each row
declare
