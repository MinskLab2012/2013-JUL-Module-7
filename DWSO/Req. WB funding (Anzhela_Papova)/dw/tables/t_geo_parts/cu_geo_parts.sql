--drop view dw.cu_geo_parts;

--==============================================================
-- View: cu_geo_parts                                           
--==============================================================
create or replace view dw.cu_geo_parts as
select
   src.geo_id,
...
comment on column dw.cu_geo_parts.geo_id is
'Unique ID for All Geography objects';

comment on column dw.cu_geo_parts.part_id is
