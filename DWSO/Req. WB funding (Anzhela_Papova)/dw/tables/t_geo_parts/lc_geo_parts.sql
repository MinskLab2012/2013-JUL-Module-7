...
--
--drop table dw.lc_geo_parts cascade constraints;

--==============================================================
-- Table: lc_geo_parts                                          
--==============================================================
create table dw.lc_geo_parts 
(
...
comment on table dw.lc_geo_parts is
'Localization table: T_GEO_SYSTEMS';

comment on column dw.lc_geo_parts.geo_id is
'Unique ID for All Geography objects';

comment on column dw.lc_geo_parts.part_id is
'ID Code of Part of World';

comment on column dw.lc_geo_parts.part_code is
'Code of Part of World';

comment on column dw.lc_geo_parts.part_desc is
'Description of Part of World';

comment on column dw.lc_geo_parts.localization_id is
...
alter table dw.lc_geo_parts
   add constraint FK_LC_CONTINENTS foreign key (geo_id)
      references dw.t_geo_parts (geo_id)
      on delete cascade;
