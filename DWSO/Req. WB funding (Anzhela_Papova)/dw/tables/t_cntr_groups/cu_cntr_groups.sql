--drop view dw.cu_cntr_groups;

--==============================================================
-- View: cu_cntr_groups                                         
--==============================================================
create or replace view dw.cu_cntr_groups as
SELECT src.geo_id
...
comment on column dw.cu_cntr_groups.geo_id is
'Unique ID for All Geography objects';

comment on column dw.cu_cntr_groups.group_id is
