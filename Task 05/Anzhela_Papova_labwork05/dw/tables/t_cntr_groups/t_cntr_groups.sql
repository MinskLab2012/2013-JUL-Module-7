--drop trigger dw.bi_t_cntr_groups
--/
--
--alter table dw.t_cntr_groups
--   drop constraint FK_T_GEO_OBJECTS2CNTR_GROUPS
--/
--
--drop table dw.t_cntr_groups cascade constraints
--/

--==============================================================
-- Table: t_cntr_groups                                         
--==============================================================
create table dw.t_cntr_groups 
(
...
comment on table dw.t_cntr_groups is
'Referense store: Grouping Countries - Groups'
/

comment on column dw.t_cntr_groups.geo_id is
'Unique ID for All Geography objects'
/

comment on column dw.t_cntr_groups.group_id is
...
create trigger dw.bi_t_cntr_groups before insert
on dw.t_cntr_groups for each row
declare
