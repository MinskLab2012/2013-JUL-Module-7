--drop view dw.cu_geo_regions;

--==============================================================
-- View: cu_geo_regions                                         
--==============================================================
create or replace view dw.cu_geo_regions as
SELECT src.geo_id
...
comment on column dw.cu_geo_regions.geo_id is
'Unique ID for All Geography objects';

comment on column dw.cu_geo_regions.src_continent_id is
