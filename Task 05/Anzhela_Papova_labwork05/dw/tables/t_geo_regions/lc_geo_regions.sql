...
--
--drop table dw.lc_geo_regions cascade constraints;

--==============================================================
-- Table: lc_geo_regions                                        
--==============================================================
create table dw.lc_geo_regions 
(
...
comment on table dw.lc_geo_regions is
'Localization table: T_GEO_SYSTEMS';

comment on column dw.lc_geo_regions.geo_id is
'Unique ID for All Geography objects';

comment on column dw.lc_geo_regions.region_id is
'ID Code of Geographical Continent - Regions';

comment on column dw.lc_geo_regions.region_code is
'Code of Continent Regions';

comment on column dw.lc_geo_regions.region_desc is
'Description of Continent Regions';

comment on column dw.lc_geo_regions.localization_id is
...
alter table dw.lc_geo_regions
   add constraint FK_LC_GEO_REGIONS foreign key (geo_id)
      references dw.t_geo_regions (geo_id)
      on delete cascade;
