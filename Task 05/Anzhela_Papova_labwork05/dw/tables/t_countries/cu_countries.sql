--drop view dw.cu_countries;

--==============================================================
-- View: cu_countries                                           
--==============================================================
create or replace view dw.cu_countries as
SELECT src.geo_id
...
comment on column dw.cu_countries.geo_id is
'Unique ID for All Geography objects';

comment on column dw.cu_countries.country_id is
'ID Code of Country';
