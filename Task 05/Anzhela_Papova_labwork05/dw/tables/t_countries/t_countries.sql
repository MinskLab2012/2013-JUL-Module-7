--drop trigger dw.bu_t_countries
--/
--
...
--/
--
--alter table dw.t_countries
--   drop constraint FK_T_GEO_OBJECTS2COUNTRIES
--/
--
--drop table dw.t_countries cascade constraints
--/

--==============================================================
-- Table: t_countries                                           
--==============================================================
create table dw.t_countries 
(
...
comment on table dw.t_countries is
'Referense store: Geographical Countries'
/

comment on column dw.t_countries.geo_id is
'Unique ID for All Geography objects'
/

comment on column dw.t_countries.country_id is
'ID Code of Country'
/
...
create trigger dw.bu_t_countries before insert
on dw.t_countries for each row
declare
