--drop view dw.cu_cntr_sub_groups;

--==============================================================
-- View: cu_cntr_sub_groups                                     
--==============================================================
create or replace view dw.cu_cntr_sub_groups as
SELECT src.geo_id
...
comment on column dw.cu_cntr_sub_groups.geo_id is
'Unique ID for All Geography objects';

comment on column dw.cu_cntr_sub_groups.sub_group_id is
