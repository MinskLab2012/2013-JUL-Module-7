--drop trigger dw.bu_t_geo_system
--/
--
...
--drop table dw.t_geo_systems cascade constraints
--/

--==============================================================
-- Table: t_geo_systems                                         
--==============================================================
create table dw.t_geo_systems 
(
...
comment on table dw.t_geo_systems is
'Abstarct Referense store all Geography objects'
/

comment on column dw.t_geo_systems.geo_id is
'Unique ID for All Geography objects'
/

comment on column dw.t_geo_systems.geo_system_id is
...
create trigger dw.bu_t_geo_system before insert
on dw.t_geo_systems for each row
declare
