--drop view dw.cu_geo_systems;

--==============================================================
-- View: cu_geo_systems                                         
--==============================================================
create or replace view dw.cu_geo_systems as
SELECT src.geo_id
...
comment on column dw.cu_geo_systems.geo_id is
'Unique ID for All Geography objects';

comment on column dw.cu_geo_systems.src_geo_system_id is
