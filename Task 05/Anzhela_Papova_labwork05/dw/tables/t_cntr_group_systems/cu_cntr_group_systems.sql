--drop view dw.cu_cntr_group_systems;

--==============================================================
-- View: cu_cntr_group_systems                                  
--==============================================================
create or replace view dw.cu_cntr_group_systems as
SELECT src.geo_id
...
comment on column dw.cu_cntr_group_systems.geo_id is
'Unique ID for All Geography objects';

comment on column dw.cu_cntr_group_systems.grp_system_id is
